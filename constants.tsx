...
export const DICTIONARY: Record<string, Record<Language, string>> = {
  ...
  activeAssessments: { en: 'Active Assessments', hi: 'सक्रिय मूल्यांकन', mr: 'सक्रिय मूल्यांकन' },
  actionRequired: { en: 'Action Required', hi: 'कार्रवाई आवश्यक', mr: 'कृती आवश्यक' },
  allTaxesPaid: { en: 'All Taxes Paid', hi: 'सभी टैक्स का भुगतान किया गया', mr: 'सर्व कर भरले आहेत' },
  noPendingDues: { en: 'No pending dues', hi: 'कोई बकाया नहीं', mr: 'कोणतीही थकबाकी नाही' },
  recentSettlements: { en: 'Recent Settlements', hi: 'हाल के भुगतान', mr: 'अलीकडील देयके' },
  noRecentPayments: { en: 'No recent payments', hi: 'कोई हालिया भुगतान नहीं', mr: 'कोणतेही अलीकडील देयके नाहीत' },
  payMonthlyBill: { en: 'Pay Monthly Bill', hi: 'मासिक बिल का भुगतान करें', mr: 'मासिक बिल भरा' },
  ...
  totalPaid: { en: 'Total Paid', hi: 'कुल भुगतान', mr: 'एकूण पेमेंट' },
  ...
  pendingBills: { en: 'Pending Bills', hi: 'लंबित बिल', mr: 'प्रलंबित बिले' },
  aiConsult: { en: 'AI Consult', hi: 'एआई परामर्श', mr: 'एआय सल्ला' },
  reportIssue: { en: 'Report an issue or ask for help', hi: 'किसी समस्या की रिपोर्ट करें या मदद मांगें', mr: 'समस्येची तक्रार करा किंवा मदत मागा' },
  generalTaxRemark: { en: 'General maintenance and property development taxes as per Gram Panchayat resolution.', hi: 'ग्राम पंचायत प्रस्ताव के अनुसार सामान्य रखरखाव और संपत्ति विकास कर।', mr: 'ग्रामपंचायत ठरावानुसार सामान्य देखभाल आणि मालमत्ता विकास कर.' },
  homeTax: { en: 'Home Tax', hi: 'घर पट्टी', mr: 'घर पट्टी' },
  waterTax: { en: 'Water Tax', hi: 'पाणी पट्टी', mr: 'पाणी पट्टी' },
  gsBill: { en: 'GS Bill', hi: 'जीएस बिल', mr: 'जीएस बिल' },
  otherService: { en: 'Other Service', hi: 'अन्य सेवा', mr: 'इतर सेवा' },
  electricityBill: { en: 'Electricity Bill', hi: 'बिजली बिल', mr: 'वीज बिल' },
  gasBill: { en: 'Gas Bill', hi: 'गैस बिल', mr: 'गॅस बिल' },
  availablePortals: { en: 'Available Portals', hi: 'उपलब्ध पोर्टल', mr: 'उपलब्ध पोर्टल' },
  ...
  operatingHours: { en: 'Operating Hours', hi: 'संचालन के घंटे', mr: 'कामाची वेळ' },
  uploadProof: { en: 'Upload Business Proof', hi: 'व्यवसाय प्रमाण अपलोड करें', mr: 'व्यवसाय पुरावा अपलोड करा' },
  shopName: { en: 'Shop Name', hi: 'दुकान का नाम', mr: 'दुकानाचे नाव' },
  businessName: { en: 'Business Name', hi: 'व्यवसाय का नाम', mr: 'व्यवसायाचे नाव' },
  businessIssues: { en: 'Report business issues or updates', hi: 'व्यवसाय संबंधी समस्याओं या अपडेट की रिपोर्ट करें', mr: 'व्यवसाय समस्या किंवा अपडेटची तक्रार करा' },
  getListed: { en: 'Get your shop listed in directory', hi: 'अपनी दुकान को सूची में शामिल करें', mr: 'तुमचे दुकान सूचीमध्ये समाविष्ट करा' },
  owner: { en: 'Owner', hi: 'मालिक', mr: 'मालक' },
  all: { en: 'All', hi: 'सभी', mr: 'सर्व' },
  searchShops: { en: 'Search shops or services...', hi: 'दुकानें या सेवाएं खोजें...', mr: 'दुकाने किंवा सेवा शोधा...' },
  exploreLocalServices: { en: 'Explore local services & shops', hi: 'स्थानीय सेवाओं और दुकानों को खोजें', mr: 'स्थानिक सेवा आणि दुकाने शोधा' },
  villageBusinessHub: { en: 'Village Business Hub', hi: 'गांव व्यवसाय हब', mr: 'गाव व्यवसाय केंद्र' },
  localMarketplace: { en: 'Local Marketplace', hi: 'स्थानीय बाजार', mr: 'स्थानिक बाजारपेठ' },
  newListing: { en: 'New Business Listing', hi: 'नई व्यवसाय सूची', mr: 'नवीन व्यवसाय नोंदणी' },
